...
const DashboardContent: React.FC = () => {
    ...
    return (
      <Box sx={{ my: 4 }}>
        ...
        >
          ...
          <Typography
            variant="body1"
            sx={{ mt: 2, mb: 4, color: 'text.secondary', maxWidth: 600, mx: 'auto' }}
          >
            No se encontraron registros en la base de datos. Verifica la conexión con Firebase y que
            la colección 'emotion_data' contenga documentos.
          </Typography>
  ...
  const recentBpmAvg =
    records.slice(0, 10).reduce((sum, record) => sum + record.bpm, 0) /
